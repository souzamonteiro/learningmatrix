...
#../../../bin/mknet.gua --prefix net/net --nfiles 100 -n 26 --topology smallworld -d 13.1154 -p 0.6 --ni 5 --tseed
...
../../../bin/denormalize.gua -i test_out_training.csv -o test_out_training_denormalized.csv --min "-3.54" --max 4088
../../../bin/denormalize.gua -i net/net_output_avg.csv -o net/net_output_avg_denormalized.csv --min "-3.54" --max 4088
