...
../../bin/learningmatrix.gua -i data_in.csv -o data_out.csv -c net.csv -r net.rep --cf net_correctness.csv --its data_in_training.csv --ots data_out_training.csv --ann net.net --annout net_out.net --lrate 0.005 --af tanh --oaf linear --of linear --ofc "[1.0, 0.4]" --loops --prepare --nw --epochs 2000 --interval 200
